...
const buttonVariants = {
  variant: {
    default:
      "bg-terracotta-dark text-white hover:bg-bark shadow-lift hover:shadow-hover",
    secondary: "bg-cream-dark text-bark hover:bg-border shadow-sm",
    outline: "border border-border bg-surface text-bark hover:bg-cream-dark",
